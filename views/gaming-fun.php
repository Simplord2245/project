                            ...
                            <div class="woocommerce-content-wrap">
                                ...
                                <div class="woocommerce-content-inner">
                                    <ul class="products three-column clearfix">
                                        <?php foreach($gaming as $game) :?>
                                        <li class="product">
                                            <div class="product-holder">
                                                <a href="<?php $this->url('shop-single');?>?id=<?php echo $game->id;?>"><img src="<?php $this->url('assets/img/product/'.$game->image);?>" alt=""></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>?id=<?php echo $game->id;?>"><?php echo limitString($game->name);?></a></h2>
                                                <span class="product__available">Available: <span><?php echo $game->quantity;?></span></span>
                                                <span class="product__available">Sold: <span><?php echo $game->sold;?></span></span>
                                                <div class="product__progress progress color-primary">
                                                    <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <?php if($game->sale > 0):?>
                                                <h4 class="product__price"><span class="new">$<?php echo number_format($game->price_sale);?></span><span class="old">$<?php echo number_format($game->price);?></span></h4>
                                                <?php else :?>
                                                    <h4 class="product__price"><span class="new">$<?php echo number_format($game->price);?></span>
                                                <?php endif ?>
