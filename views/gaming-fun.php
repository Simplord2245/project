                                    ...
                                    <ul class="products three-column clearfix">
                                        ...
                                        <li class="product">
                                            <div class="product-holder">
                                                <a href="<?php $this->url('shop-single');?>"><img src="<?php $this->url('assets/img/product/'.$game->image);?>" alt=""></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>"><?php echo limitString($game->name);?></a></h2>
