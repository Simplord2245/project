                            ...
                            <tbody>
                                ...
                                <tr class="cart_single">
                                    <td class="product-remove">
                                        <a onclick="return confirm('Bạn có muốn xoá sản phẩm này không?')" href="<?php $this->url('cart-delete?id='.$cart->id);?>" class="remove" title="Remove this item" data-product_id="8"
                                    ...
                                    <td class="product-quantity" data-title="Quantity">
                                        ...
                                        <div >
                                            <button class="thm-btn thm-btn__2 br-0 no-icon" style="padding: 0px 20px;" type="submit">Update</button>
                                        </div>
                                        </form>
                                    </td>
                        ...
                        <div class="cart_totals calculated_shipping">
                            ...
                            <table class="shop_table shop_table_responsive">
                                ...
                                <tr class="order-total">
                                    <th>Total</th>
                                    <td data-title="Total"><strong><span>$<?php echo number_format($tt);?></span></strong>
                                    </td>
                                </tr>
                            </table>
