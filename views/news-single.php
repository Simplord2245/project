                ...
                <div class="container">
                    <div class="radios-breadcrumb breadcrumbs">
                        <ul class="list-unstyled d-flex align-items-center">
                            ...
                            <li class="radiosbcrumb-item radiosbcrumb-begin">
                                <a href="<?php $this->url('news');?>"><span>News</span></a>
                            </li>
                            ...
                            <div class="blog-post-wrap mt-50">
                                <article class="post-details">
                                    ...
                                    <blockquote class="mt-40">
                                        ...
                                        <img class="quote" src="assets/img/icon/quote.html" alt="">
                                    </blockquote>
                                    ...
                                    <div class="row post-nav">
                                        <div class="col-lg-6 col-md-6">
                                            <div class="post-nav__wrap left-post">
                                                ...
                                                <div class="post-nav__item tx-post ul_li">
                                                    <div class="post-thumb">
                                                        <a href="<?php $this->url('news-single');?>"><img src="assets/img/news/img_20.jpg" alt=""></a>
                                                    </div>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            <div class="post-nav__wrap right-post">
                                                ...
                                                <div class="post-nav__item tx-post ul_li">
                                                    <div class="post-thumb">
                                                        <a href="<?php $this->url('news-single');?>"><img src="assets/img/news/img_21.jpg" alt=""></a>
                                                    </div>
                                                    <div class="post-content">
