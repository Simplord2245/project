                                    ...
                                    <ul class="products three-column clearfix">
                                        ...
                                        <li class="product">
                                            <div class="product-holder">
                                                <a href="<?php $this->url('shop-single');?>?id=<?php echo $cam->id;?>"><img src="<?php $this->url('assets/img/product/'.$cam->image);?>" alt=""></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>?id=<?php echo $cam->id;?>"><?php echo limitString($cam->name);?></a></h2>
                                                <span class="product__available">Available: <span><?php echo $cam->quantity;?></span></span>
                                                <span class="product__available">Sold: <span><?php echo $cam->sold;?></span></span>
                                                <div class="product__progress progress color-primary">
                                                    <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                                <?php if($cam->sale > 0):?>
                                                <h4 class="product__price"><span class="new">$<?php echo number_format($cam->price_sale);?></span><span class="old">$<?php echo number_format($cam->price);?></span></h4>
                                                <?php else :?>
                                                    <h4 class="product__price"><span class="new">$<?php echo number_format($cam->price);?></span>
                                                <?php endif ?>
