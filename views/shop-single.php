...
if($id){
    $product = Products::join('id, name, status, price, sale, image, quantity, sold, category_id, descriptions,price - (price * sale/100) as price_sale','category_id','id','categories.name as cat_name')->where('id',$id)->groupBy('id, name, status, price, sale, image, quantity, sold, descriptions')->find();
    $relatedproduct = Products::select($field_sale)->where('category_id',$product->category_id)->orderBy('','rand()')->limit(4)->get();
    }
?>
<!-- breadcrumb start -->
                    ...
                    <div class="product_details_img ">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="pl_thumb">
                                    <img src="<?php echo $this->url('assets/img/product/'.$product->image);?>" alt="">
                                </div>
                            </div>
            ...
            <div class="col-md-6 product-details-col">
                <div class="product-details">
                    ...
                    <div class="price">
                        ...
                        <span class="new">$<?php echo number_format($product->price_sale);?></span>
                        <span class="old">$<?php echo number_format($product->price);?></span>
                        <?php else :?>
                        <span class="new">$<?php echo number_format($product->price);?></span>
                        <?php endif ?>
                    </div>
                    <p><?php echo limitString($product->descriptions,50);?></p>
                    ...
                    <div class="thb-product-meta-before mt-20">
                        <div class="product_meta">
                            <span class="posted_in">Category: <?php echo $product->cat_name?></span>
                        ...
                        <ul class="products clearfix">
                            ...
                            <li class="product">
                                ...
                                <div class="product-info">
                                    ...
                                    <?php if($related->sale > 0):?>
                                    <h4 class="product__price"><span class="new">$<?php echo number_format($related->price_sale);?></span><span
                                            class="old">$<?php echo number_format($related->price);?></span></h4>
                                            <?php else :?>
                                                <h4 class="product__price"><span class="new">$<?php echo number_format($related->price);?></span>
                                            <?php endif ?>
                                </div>
                            </li>
                            <?php endforeach ?>
