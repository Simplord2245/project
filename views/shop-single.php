                                    ...
                                    <ul class="products clearfix">
                                        <li class="product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>">Rokinon Xeen CF 16mm T2.6 Pro Cinema Wide</a></h2>
                                        ...
                                        <li class="product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>">Tab M10 Plus, FHD Android Tablet, Processor</a></h2>
                                                <span class="product__available">Available: <span>334</span></span>
                                                <div class="product__progress progress color-primary">
                                                    <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                        ...
                                        <li class="product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>">Portable 2TB External Hard Drive Portable HDD USB</a></h2>
                                                <span class="product__available">Available: <span>334</span></span>
                                                <div class="product__progress progress color-primary">
                                                    <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                        ...
                                        <li class="product">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product__title"><a href="<?php $this->url('shop-single');?>">Skullcandy Dime True In-Ear Earbuds – Golden</a></h2>
                                                <span class="product__available">Available: <span>334</span></span>
                                                <div class="product__progress progress color-primary">
                                                    <div class="progress-bar" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
